...
import numpy as np
import zlib
import imageio.v2 as imageio  # imageio v2 for backward compatibility in Python 3
import cv2
import png
...
class SensorData:
    ...
    def export_poses(self, output_path, frame_skip=1):
        ...
        for idx, frame in enumerate(self.frames[::frame_skip]):
            self.save_mat_to_file(frame.camera_to_world, os.path.join(output_path, f'{idx}.txt'))
